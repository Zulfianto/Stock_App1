    ...
    html.Div([
        dbc.Row([
            dbc.Col([html.Div([
                ...
                dcc.Interval(id="graph-update1", disabled=False, interval=10*1000, max_intervals=-1, n_intervals=0)
                ],
                style={'margin': '0px 0px 0px 0px', 'width': '98%'}),]),
            dbc.Col([html.Div([
                #dcc.Graph(figure=data1)
                dcc.Graph(id="graph", animate=False),
                dcc.Interval(id="graph-update", disabled=False, interval=10*1000, max_intervals=-1, n_intervals=0)
                ],
                style={'margin': '0px 0px 0px 0px', 'width': '98%'}),])
        ], className="g-0")
        ])
